//the array that hold the subjects//
...
document.getElementById('objective').innerHTML = "Draw me a / " + Element_of_array;
//main variables//
timer_counter = 1000;
timer_check = "";
drawn_sketch = "";
...
document.getElementById('objective').innerHTML = 'Draw me a / ' + sketch;
}
function setup() {
